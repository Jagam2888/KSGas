...
public class DealerRequest extends ActivityManager implements View.OnClickListener{
    ...
    TextView emailTxt,phoneTxt,msgTxt;
    Button submit;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailTxt = (TextView)findViewById(R.id.your_email);
        emailTxt.setText("jagadeesh2188@gmail.com");
        phoneTxt = (TextView)findViewById(R.id.your_phone);
        msgTxt = (TextView)findViewById(R.id.your_msg);
